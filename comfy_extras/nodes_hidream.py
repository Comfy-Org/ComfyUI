...
class QuadrupleCLIPLoader(io.ComfyNode):
    ...
    @classmethod
    def execute(cls, clip_name1, clip_name2, clip_name3, clip_name4, device="default"):
        ...
        clip = comfy.sd.load_clip(ckpt_paths=[clip_path1, clip_path2, clip_path3, clip_path4], embedding_directory=folder_paths.get_folder_paths("embeddings"), model_options=model_options)
