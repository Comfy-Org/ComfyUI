...
class YuE2GenerateABC(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            description="Generates an ABC score from style and lyrics. Connect abc to YuE2 Generate Music, or edit the score before using it.",
            inputs=[
                io.Clip.Input("clip"),
                io.String.Input("style", multiline=True, dynamic_prompts=True),
                io.String.Input("lyrics", multiline=True, dynamic_prompts=True),
                io.Combo.Input("cot", options=["full", "melody"]),
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("cot", options=["full", "melody"], tooltip="Score mode when ABC is supplied. An empty ABC input automatically uses off mode."),
                io.Int.Input("seed", default=0, min=0, max=0xffffffffffffffff, control_after_generate=True),
