...
def estimate_memory(model, noise_shape, conds):
    ...
    if memory_efficient_attention is None:
        ...
        memory_required = model.model.memory_required([noise_shape[0] * 2] + list(noise_shape[1:]), cond_shapes=cond_shapes, memory_efficient_attention=memory_efficient_attention)
        minimum_memory_required = model.model.memory_required([noise_shape[0]] + list(noise_shape[1:]), cond_shapes=cond_shapes_min, memory_efficient_attention=memory_efficient_attention)
