...
parser.add_argument("--vae-kl-mem-ratio", type=float, default=None, metavar="RATIO", help="Override the VAE memory estimation ratio used in AutoencoderKL (affects memory_used_encode/decode calculations). Default is 2.73 for AMD/ROCm (lowering to ~1.3 recommended for modern ROCm per some reports) or 1.0 otherwise. Useful for tuning VRAM usage vs risk of VAE corruption. Set via CLI for benchmarking.")
