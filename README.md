...
1. Install the ComfyUI [dependencies](#dependencies). If you have another Stable Diffusion UI [you might be able to reuse the dependencies](#how-do-i-share-models-between-another-ui-and-comfyui).
